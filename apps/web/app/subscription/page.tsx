            ...
            <article className="rounded-md border border-slate-200 p-5" key={plan.code}>
              ...
              <ul className="mt-4 space-y-2 text-sm text-slate-600">
                <li className="flex gap-2">
                  <CheckCircle2 className="h-4 w-4 text-emerald-600" /> {plan.maxProperties >= 100000 ? 'Unlimited' : plan.maxProperties} properties
                </li>
                <li className="flex gap-2">
                  <CheckCircle2 className="h-4 w-4 text-emerald-600" /> {plan.maxRooms >= 100000 ? 'Unlimited' : plan.maxRooms} rooms
                </li>
                <li className="flex gap-2">
                  <CheckCircle2 className="h-4 w-4 text-emerald-600" /> {plan.maxStaffUsers >= 100000 ? 'Unlimited' : plan.maxStaffUsers} staff users
                </li>
                <li className="flex gap-2">
                  <CheckCircle2 className="h-4 w-4 text-emerald-600" /> {plan.channelManager ? 'Channel manager architecture' : 'No channel manager'}
                </li>
              </ul>
